...
class EndpointSerializer(serializers.ModelSerializer):
    class Meta:
        model = Endpoint
        read_only_fields = ('id', 'name', 'owner', 'created_at', 'update_at')
...
class MLAlgorithmSerializer(serializers.ModelSerializer):
    ...
    def get_current_status(self, ml_algorithm):
        return MLAlgorithmStatus.objects.filter(parent_ml_algorithm=ml_algorithm).latest('created_at').status
